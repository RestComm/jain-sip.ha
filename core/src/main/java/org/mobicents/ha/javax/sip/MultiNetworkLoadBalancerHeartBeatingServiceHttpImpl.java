 ...
 *
 */
public class MultiNetworkLoadBalancerHeartBeatingServiceHttpImpl implements LoadBalancerHeartBeatingService, MultiNetworkLoadBalancerHeartBeatingServiceHttpImplMBean {

	private static StackLogger logger = CommonLogger.getLogger(MultiNetworkLoadBalancerHeartBeatingServiceHttpImpl.class);
    ...
    public MultiNetworkLoadBalancerHeartBeatingServiceHttpImpl() {
